...
# The weird thing is if numpy from the defaults channel is used, 
# the "import mantid" test will fail with a seg fault.
# Forcing CONDA_NPY here will allow the conda-forge version of numpy being used:
#   1.11.3-py27_blas_openblas_200
